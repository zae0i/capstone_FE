  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <h1 style={{ margin: 0, fontSize: '1.5em' }}>개인 리포트</h1>
        <nav>
          <ul style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', gap: '20px' }}>
            ...
            <li><Link to="/transactions" style={{ color: 'white', textDecoration: 'none' }}>거래 내역</Link></li>
            <li><Link to="/ranking" style={{ color: 'white', textDecoration: 'none' }}>랭킹</Link></li>
            <li><Link to="/report" style={{ color: 'white', textDecoration: 'none', fontWeight: 'bold' }}>리포트</Link></li>
